...
output_directory = r"D:\codes\camera_calib_IIITA\itr2\cam_0"
...
try:
    ...
    while True:
        ...
        rgb_filename = os.path.join(output_directory,"rgb",f"{frame_counter}.png")
        depth_filename = os.path.join(output_directory,"depth" ,f"{frame_counter}.png") # Indicate it's aligned
